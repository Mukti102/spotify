...
function Sponsored() {
  return (
    <div className=" py-5 px-4 flex gap-6 over overflow-hidden items-center h-64 bg-[#000] rounded-md mt-1">
      ...
      <div className=" gap-4 flex flex-col justify-center h-full">
